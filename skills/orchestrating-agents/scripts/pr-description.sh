...
#   TRACKER_ID         — tracker ticket ID (same as TASK_ID, tracker-framed)
#   PARENT_TICKET_ID   — parent/epic ticket ID
#   FEATURE_FLAG       — feature flag name/key
#
...
# Append optional metadata lines when values are available
